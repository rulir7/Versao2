...
const animatedButton = document.getElementById('animacao-botao');

animatedButton.addEventListener('click', function() {
  this.classList.add('slide-out-elliptic-top-bck');
  
  // Adicione um atraso para remover a classe de animação após a conclusão da animação
  setTimeout(() => {
    this.classList.remove('slide-out-elliptic-top-bck');
  }, 0500); // 2000ms é o tempo da animação
});
